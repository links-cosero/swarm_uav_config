...
class ViconRos2 : public rclcpp::Node
{
  public:
    ...
    : Node("vicon")
    {
      ...
      timer_ = this->create_wall_timer(
        20ms, std::bind(&ViconRos2::timer_callback, this));
    }
  ...
  private:
    ...
    px4_msgs::msg::VehicleOdometry create_odom_msg(geometry_msgs::msg::PoseStamped pose, float latency){
      ...
      new_msg.timestamp = int(pose.header.stamp.nanosec / 1000);
      new_msg.timestamp_sample = new_msg.timestamp - latency / 1e-6;
